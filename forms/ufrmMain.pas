...
begin
  ...
  try
    ...
    mmoProgresso.Lines.Add('Todos os backups foram realizados com sucesso! Término em: '+FormatDateTime('DD-MM-YYYY HH-MM-SS',Now));
...
procedure TfrmMain.Limpar1Click(Sender: TObject);
begin
  mmoProgresso.Lines.Clear;
end;
...
begin
  ...
  mmoProgresso.Lines.Add('Backup realizado com sucesso');
  mmoProgresso.Lines.Add('Zipando Backup');
  ...
  mmoProgresso.Lines.Add('Arquivo zipado com sucesso');
